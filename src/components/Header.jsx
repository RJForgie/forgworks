...
function FloppyDiscIcon(props) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M8.75 19V15.75C8.75 15.1977 9.19772 14.75 9.75 14.75H14.25C14.8023 14.75 15.25 15.1977 15.25 15.75V19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8.75 5V8.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
...
function MobileNavigation(props) {
  return (
    <Popover {...props}>
      <Popover.Button className="px-4 py-2 text-sm font-medium backdrop-blur bg-zinc-900 text-zinc-200">
      ...
      <Transition.Root>
        ...
        >
          <Popover.Panel
            focus
            className="fixed inset-x-4 top-8 z-50 origin-top rounded-3xl p-8 ring-1 bg-zinc-900 ring-zinc-800 font-mono uppercase"
          >
...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex text-md font-medium font-mono text-zinc-200">
        ...
        >
          ...
          >
            <div className="flex justify-between gap-4">
              <Link href="/" className="pointer-events-auto pr-3 py-2 flex">
                <FloppyDiscIcon className="mr-4 text-orange-400" />
                <h2 className="text-md font-medium font-mono text-zinc-200 hover:text-orange-400">
                  Ryan Forgie
                </h2>
              </Link>
